...
class Model {
  ...
  public:
    void setVertices(GLfloat * vertices, GLuint vertices_count);
    void setColors(GLfloat * colors, GLuint colors_count);
    void setIndices(GLuint * indices, GLuint indices_count);
  ...
  private:
    ...
    //TODO: maybe get rid of data in RAM and pass it exclusively in VRAM?
    GLfloat * m_vertices;
    GLfloat * m_colors;
    GLuint * m_indices;

    GLuint m_vertices_count;
    GLuint m_colors_count;
